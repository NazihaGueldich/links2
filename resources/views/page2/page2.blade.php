            ...
            <div class="row block-cards">
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body d-flex flex-column">
                            <h5 class="titre-2">아프리카 최북단</h5>
                            <img src="{{ asset('images/afrique.png') }}" class="img2-section3">
                            <p class="parghraphe1">아프리카 대륙의 최북단에 위치하며, 아틀라스 산맥을 따라 자리 잡은 나라들 중 가장 작은 국가예요.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body d-flex flex-column">
                            <h5 class="titre-2">북아프리카</h5>
                            <img src="{{ asset('images/PointAfrique.png') }}" class="img1-section3">
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body d-flex flex-column">
                            <h5 class="titre-2">지중해</h5>
                            <img src="{{ asset('images/Mer-image.png') }}"class="img3-section3" >
                            <p class="parghraphe1">지중해 서부 연안에 위치한 아프리카와 유럽의 관문이기도 해요.</p>
                        </div>
                    </div>
                </div>
