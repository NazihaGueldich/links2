        ...
        <div class="container">
            <div class="card2 pt-3">
                <div class="op">
                    ...
                    <p id="txt2" class="txtinactv">튀니지는 세계 최초의 대학이 있는 특별한 곳입니다. 737년에 설립된 자이투나 대학은 튀니지의 교육 수준과 지적 발전에 대한 헌신을 보여줍니다. </p>

                    <img id='img3Cnt' class='imginactv' src="images/tmp_1697673183049.jpg">
                    <p id="txt3" class="txtinactv">2021년 튀니지는 200만 명의 관광객을 맞이하며 관광업에서 상당한 부상을 보였습니다. 아름다운 지중해 해안, 역사적 유산 및 다양한 명소로 전 세계의 방문객들을 끌어들이고 있습니다. </p>
                </div>
            </div>
        </div>
    </section>
