                            ...
                            <div id="taxi" class="tab-pane fade">
                                <div class="row">
                                    <div class="col-md-6 pr-0 pr-md-3">
                                        ...
                                        <p>차량 오른쪽 아래에 빨간색 표시등이 켜져 있으면 빈 택시, <br>초록색 표시등이 켜져 있으면 이미 운행 중이라는 의미에요. <br>기본요금은
                                            우리나라 기본요금의 약 1/10에서 시작합니다.<br> 밤 9시부터 새벽 5시까지는 야간 할증이 적용돼요.</p>
                                        <p>‘Bolt’ 앱을 통해 택시를 이용하면 일반 택시보다 조금 더 비싸지만 <br>편하게 튀니지를 다닐 수 있어요.</p>
                                    </div>
                                    <div class="col-md-6">
                            ...
                            <div id="trnmet" class="tab-pane fade">
                                <div class="row">
                                    <div class="col-md-6 pr-0 pr-md-3">
                                        ...
                                        <p>TGM이라고 불리는 트램도 운행합니다. <br>튀니스 시내 중심부터 유명 관광지 카르타고, 시디 부 사이드, 라 마르사 등을 연결해요.<br>
                            ...
                            <li>
                                <div class="museums-card">
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <div class="card-text">
                                            <p>바르도 박물관은 튀니지 전역에서 발굴된 유물들을 비롯해 <br>그리스, 로마, 이집트 유물을 시대별로 전시해 놓았어요.</p>
