@include('layouts.front.head')
    ...
    <meta name="keywords" content="튀니지 음식
                            ...
                            <div id="taxi" class="tab-pane fade">
                                <div class="row">
                                    <div class="col-md-6 pr-0 pr-md-3">
                                        ...
                                        <p>튀니지의 택시는 노란색이라 눈에 쉽게 띈다는 장점이 있어요.<br>차량 오른쪽 아래에 빨간색 표시등이 켜져 있으면 빈 택시, <br>초록색 표시등이 켜져 있으면 이미 운행 중이라는 의미에요. <br>기본요금은
                                            우리나라 기본요금의 약 1/10에서 시작합니다.<br> 밤 9시부터 새벽 5시까지는 야간 할증이 적용돼요.<br>‘Bolt’ 앱을 통해 택시를 이용하면 일반 택시보다 조금 더 비싸지만 <br>편하게 튀니지를 다닐 수 있어요.</p>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6 pr-0 pr-md-3">
                                        ...
                                        <p>루아지는 시외 이동 시 이용하는 합동 승합 택시 개념의 미니버스예요. 이동경로와 요금이 정해져 있어요. 8명의 승객이 다 찰
                                            때까지 기다렸다가 출발하기 때문에 시간표는 없습니다.<br>시외 이동을 위한 루아지 탑승 정류장은 아래를 확인하세요.<br>Station louage Beb Alioua ; 서남부 (Hammamet, Nabeul 등)<br>Station louage Beb Saadoun ; 북부 (Bizerte, Tabarka 등)<br>Station louage Moncef Bey ; 남부 (Sousse, Sfax, Djerba)</p>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6 pr-0 pr-md-3">
                                        ...
                                        <p>수도 튀니스에는 메트로라고 불리는 경전철 시스템이 있어요.<br> 총 6개 선의 노선을 운영하며 튀니스 시내와 도심을 연결해요. <br>요금은
                                            거리에 따라 달라지지만 보통 2TND 내외입니다.<br>TGM이라고 불리는 트램도 운행합니다. <br>튀니스 시내 중심부터 유명 관광지 카르타고, 시디 부 사이드, 라 마르사 등을 연결해요.<br>
                            ...
                            <li>
                                <div class="museums-card">
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <div class="card-text">
                                            <p class="lignhght">바르도 박물관은 튀니지 전역에서 발굴된 유물들을 비롯해 <br>그리스, 로마, 이집트 유물을 시대별로 전시해 놓았어요.<br>특히 고대의 다양한 모자이크 장식품 등이 전시돼 있어<br>세계 최대의 모자이크 전시관으로 유명합니다.</p>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div class="museums-card">
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <div class="card-text">
                                            <p class="lignhght">카르타고 중심부, 비르사 언덕 꼭대기에 위치해요.<br>1875년에 설립된 박물관은 포에니 시대를 포함하여<br>여러 시대를 거친 고고학 유물을 보존하고 전시하고 있어요.<br>많은 유물 중에서도 카르타고 묘지에서 발굴된 기원전 3세기의 대리석 석관이 유명해요.</p>
                                        </div>
                                    </div>
                                </div>
                            </li>
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <div class="card-text">
                                            <p class="lignhght">튀니지 수스 지역에 있는 박물관으로,
                                                ...
                                                당시 사용했던 가구와 도구 등이 그대로 전시돼있어<br>중세 시대 중산층의 생활상을 확인할 수 있어요.<br>꼭대기 층에서 메디나와 바다 전경을 볼 수 있어요.</p>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div class="museums-card">
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <div class="card-text">
                                            <p class="lignhght">바르도 국립 박물관 다음으로 광범위한 모자이크 컬렉션을 자랑하는 박물관이에요.<br>사냥, 오락 등과 관련된 많은 작품을 통해 당시의 삶을 엿볼 수 있습니다.<br>모자이크 외에도 시대를 망라하는 여러 조각품을 소장하고 있어요.</p>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div class="museums-card">
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <div class="card-text">
                                            <p class="lignhght">튀니지 최초의 사설 박물관이에요.<br>1990년 튀니지 유산 홍보를 위한 여러 문화 프로젝트를 시작했던 당시 토주르의 시장,
                                                압델라자크 체레이트(Abderrazak Cherait)에 의해 설립됐어요.<br>과거 생활 장면을 엿볼 수 있는 전형적인 부엌, 터키식 목욕탕 등을 볼 수 있어요.<br>도자기, 보석, 의복, 기타 골동품 등의 전시물도 확인할 수 있습니다.</p>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div class="museums-card">
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <div class="card-text">
                                            <p class="lignhght">엘젬 박물관은 엘젬 원형 극장 근처에 위치해있습니다.<br>로마시대 번성했던 귀족의 가옥에 공간 구성을 복원하여, 1970년 처음 문을 열었습니다.<br>로마 가옥은 물론 모자이크, 조각품, 도자기 등의 전시물을 볼 수 있습니다.</p>
                                        </div>
                                    </div>
                                </div>
                            </li>
